 ...
 */
const UserModel_1 = __importDefault(require("../mongoose/User/UserModel"));
/**
...
class UserDao {
    constructor() {
        ...
        this.updateUserSalaryByUsername = (username, salary) => __awaiter(this, void 0, void 0, function* () { return UserModel_1.default.updateOne({ username }, { $set: { salary: salary } }); });
        /**
