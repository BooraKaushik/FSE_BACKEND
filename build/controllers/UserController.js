...
class UserController {
    constructor() {
         ...
         */
        this.findAllUsers = (req, res) => UserController.userDao
            .findAllUsers()
         ...
         */
        this.findUserById = (req, res) => UserController.userDao
         ...
         * database
         */
        this.createUser = (req, res) => UserController.userDao
            .createUser(req.body)
            .then((user) => res.json(user));
        /**
         ...
         */
        this.updateUser = (req, res) => UserController.userDao
         ...
         */
        this.deleteUser = (req, res) => UserController.userDao
        ...
        this.deleteUsersByUsername = (req, res) => UserController.userDao
        ...
        this.register = (req, res) => UserController.userDao
